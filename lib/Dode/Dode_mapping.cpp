...
float LEDs_cartesian[NR_TOTAL_LEDS][5];// Kartesische Koordinaten:  {Kantenindex, LED-Index, X, Y, Z}
float LEDs_spherical[NR_TOTAL_LEDS][5];// Kugel-Koordinaten:  {Kantenindex, LED-Index, r, phi, theta}
...
void Dode::generate_mapping() {
    ...
    float Ursprung[][3] = {
        {corner_B1[0],corner_B1[1],corner_B1[2]},       {corner_B2[0],corner_B2[1],corner_B2[2]},       
        {corner_L2_[0],corner_L2_[1],corner_L2_[2]},    {corner_B2_[0],corner_B2_[1],corner_B2_[2]}, 
        {corner_B3_[0],corner_B3_[1],corner_B3_[2]},    {corner_L3_[0],corner_L3_[1],corner_L3_[2]},    
        {corner_B3_[0],corner_B3_[1],corner_B3_[2]},    {corner_B3[0],corner_B3[1],corner_B3[2]}, 
        {corner_L3[0],corner_L3[1],corner_L3[2]},       {corner_B3[0],corner_B3[1],corner_B3[2]},
        {corner_B2[0],corner_B2[1],corner_B2[2]},       {corner_L2[0],corner_L2[1],corner_L2[2]},       
        {corner_B2[0],corner_B2[1],corner_B2[2]},       {corner_B3[0],corner_B3[1],corner_B3[2]}, 
        {corner_L1[0],corner_L1[1],corner_L1[2]},       {corner_L2_[0],corner_L2_[1],corner_L2_[2]},    
        {corner_H2_[0],corner_H2_[1],corner_H2_[2]},    {corner_T2_[0],corner_T2_[1],corner_T2_[2]}, 
        {corner_L3_[0],corner_L3_[1],corner_L3_[2]},    {corner_H1[0],corner_H1[1],corner_H1[2]}, 
        {corner_T1[0],corner_T1[1],corner_T1[2]},       {corner_L3[0],corner_L3[1],corner_L3[2]},       
        {corner_H2[0],corner_H2[1],corner_H2[2]},       {corner_T2[0],corner_T2[1],corner_T2[2]}, 
        {corner_L2[0],corner_L2[1],corner_L2[2]},       {corner_H3[0],corner_H3[1],corner_H3[2]},       
        {corner_T3[0],corner_T3[1],corner_T3[2]},       {corner_L1[0],corner_L1[1],corner_L1[2]}, 
        {corner_H3_[0],corner_H3_[1],corner_H3_[2]},    {corner_T3[0],corner_T3[1],corner_T3[2]}
    };
    ...
    int j=0;
    int c_x,c_y,c_z;
    for(int k=0; k<EDGE_COUNT; k++){ //über Kanten iterieren
